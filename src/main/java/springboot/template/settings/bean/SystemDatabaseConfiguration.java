package springboot.template.settings.bean;

import springboot.template.model.DatabaseMySQL;
...
import static springboot.template.util.BeanConst.*;
import static springboot.template.util.SystemPropertiesConst.*;
